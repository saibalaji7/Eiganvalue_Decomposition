...
HD_PWD='C:/Vivado_Projects/jacobi/jacobi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pairs_generating.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pairs_generating.tcl -notrace
