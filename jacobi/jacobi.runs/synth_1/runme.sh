...
HD_PWD='C:/Vivado_Projects/jacobi/jacobi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pairs_generating.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pairs_generating.tcl
