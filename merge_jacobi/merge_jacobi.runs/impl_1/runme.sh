...
HD_PWD='C:/Vivado_Projects/merge_jacobi/merge_jacobi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jacobi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jacobi.tcl -notrace
