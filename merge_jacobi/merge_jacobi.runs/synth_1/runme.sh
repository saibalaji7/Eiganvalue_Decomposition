...
HD_PWD='C:/Vivado_Projects/merge_jacobi/merge_jacobi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jacobi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jacobi.tcl
